...
public final class Snackbar extends BaseTransientBar<Snackbar> {
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence text,
        ...
        final SnackbarContentLayout content =
                (SnackbarContentLayout) inflater.inflate(
                        R.layout.view_snackbar_inside, parent, false);
    ...
    /**
     * Update the icon in this {@link Snackbar}.
     *
     * @param icon The new icon for this {@link BaseTransientBar}.
     */
    @NonNull
    public Snackbar setIcon(@NonNull Drawable icon) {
        final SnackbarContentLayout contentLayout = (SnackbarContentLayout) mView.getChildAt(0);
        final ImageView imageView = contentLayout.getImageView();
    ...
    /**
     * Update the drawable in this {@link Snackbar}.
     *
     * @param resId The new drawable for this {@link BaseTransientBar}.
     */
    @NonNull
    public Snackbar setIcon(@DrawableRes int resId) {
     ...
     *
     * @param message The new text for this {@link BaseTransientBar}.
     */
    @NonNull
     ...
     * Update the text in this {@link Snackbar}.
     *
     * @param resId The new text for this {@link BaseTransientBar}.
     */
    @NonNull
