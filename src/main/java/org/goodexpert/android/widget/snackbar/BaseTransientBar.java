 ...
 */
public class BaseTransientBar<B extends BaseTransientBar<B>> {
    ...
    public abstract static class BaseCallback<B> {
         ...
         *
         * @param transientBar The transient bottom bar which has been dismissed.
         ...
         */
        public void onDismissed(B transientBar, @DismissEvent int event) {
            // empty
        }
         ...
         *
         * @param transientBar The transient bottom bar which is now visible.
    ...
    protected BaseTransientBar(@NonNull ViewGroup parent, @NonNull View content,
        ...
        mView = (SnackbarBaseLayout) inflater.inflate(
                R.layout.view_snackbar, mTargetParent, false);
    ...
    /**
     * Set placing a snackbar within a potentially larger container.
     *
     * @param gravity either be one of the predefined gravity: Gravity.BOTTOM or Gravity.TOP {@link Gravity}.
     */
    @NonNull
     ...
     */
    @NonNull
    public B setBackgroundColor(int color) {
        if (mView != null) {
    ...
    final void showView() {
        if (mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                clp.insetEdge = mGravity;
                clp.gravity = mGravity;
